...
var exposureclassesResource = schema.GroupVersionResource{Group: "core.gardener.cloud", Version: "v1alpha1", Resource: "exposureclasses"}

var exposureclassesKind = schema.GroupVersionKind{Group: "core.gardener.cloud", Version: "v1alpha1", Kind: "ExposureClass"}
...
func (c *FakeExposureClasses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ExposureClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(exposureclassesResource, name), &v1alpha1.ExposureClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ExposureClass), err
}

// List takes label and field selectors, and returns the list of ExposureClasses that match those selectors.
func (c *FakeExposureClasses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExposureClassList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(exposureclassesResource, exposureclassesKind, opts), &v1alpha1.ExposureClassList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.ExposureClassList{ListMeta: obj.(*v1alpha1.ExposureClassList).ListMeta}
	for _, item := range obj.(*v1alpha1.ExposureClassList).Items {
...
func (c *FakeExposureClasses) Create(ctx context.Context, exposureClass *v1alpha1.ExposureClass, opts v1.CreateOptions) (result *v1alpha1.ExposureClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(exposureclassesResource, exposureClass), &v1alpha1.ExposureClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ExposureClass), err
...
func (c *FakeExposureClasses) Update(ctx context.Context, exposureClass *v1alpha1.ExposureClass, opts v1.UpdateOptions) (result *v1alpha1.ExposureClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(exposureclassesResource, exposureClass), &v1alpha1.ExposureClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ExposureClass), err
...
func (c *FakeExposureClasses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ExposureClassList{})
	return err
}
...
func (c *FakeExposureClasses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ExposureClass, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(exposureclassesResource, name, pt, data, subresources...), &v1alpha1.ExposureClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ExposureClass), err
