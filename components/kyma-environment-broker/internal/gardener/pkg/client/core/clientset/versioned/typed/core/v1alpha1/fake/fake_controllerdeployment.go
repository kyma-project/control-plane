...
var controllerdeploymentsResource = schema.GroupVersionResource{Group: "core.gardener.cloud", Version: "v1alpha1", Resource: "controllerdeployments"}

var controllerdeploymentsKind = schema.GroupVersionKind{Group: "core.gardener.cloud", Version: "v1alpha1", Kind: "ControllerDeployment"}
...
func (c *FakeControllerDeployments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ControllerDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(controllerdeploymentsResource, name), &v1alpha1.ControllerDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ControllerDeployment), err
}

// List takes label and field selectors, and returns the list of ControllerDeployments that match those selectors.
func (c *FakeControllerDeployments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ControllerDeploymentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(controllerdeploymentsResource, controllerdeploymentsKind, opts), &v1alpha1.ControllerDeploymentList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.ControllerDeploymentList{ListMeta: obj.(*v1alpha1.ControllerDeploymentList).ListMeta}
	for _, item := range obj.(*v1alpha1.ControllerDeploymentList).Items {
...
func (c *FakeControllerDeployments) Create(ctx context.Context, controllerDeployment *v1alpha1.ControllerDeployment, opts v1.CreateOptions) (result *v1alpha1.ControllerDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(controllerdeploymentsResource, controllerDeployment), &v1alpha1.ControllerDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ControllerDeployment), err
...
func (c *FakeControllerDeployments) Update(ctx context.Context, controllerDeployment *v1alpha1.ControllerDeployment, opts v1.UpdateOptions) (result *v1alpha1.ControllerDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(controllerdeploymentsResource, controllerDeployment), &v1alpha1.ControllerDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ControllerDeployment), err
...
func (c *FakeControllerDeployments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(controllerdeploymentsResource, name, opts), &v1alpha1.ControllerDeployment{})
	return err
}
...
func (c *FakeControllerDeployments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ControllerDeploymentList{})
	return err
}
...
func (c *FakeControllerDeployments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ControllerDeployment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(controllerdeploymentsResource, name, pt, data, subresources...), &v1alpha1.ControllerDeployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ControllerDeployment), err
