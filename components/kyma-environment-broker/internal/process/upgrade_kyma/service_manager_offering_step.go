...
type ServiceManagerOfferingStep struct {
	...
	extractor        func(po *internal.UpgradeKymaOperation) *internal.ServiceManagerInstanceInfo
}
...
func (s *ServiceManagerOfferingStep) handleError(operation internal.UpgradeKymaOperation, err error, msg string, log logrus.FieldLogger) (internal.UpgradeKymaOperation, time.Duration, error) {
