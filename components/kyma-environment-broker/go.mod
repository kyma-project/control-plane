...
replace (
	...
	github.com/kyma-project/control-plane/components/provisioner => github.com/vvxxvvxx/control-plane/components/provisioner v0.0.0-20211010091913-0a5282752418
)
