...
replace (
	// remove after merge PR-796
	github.com/kyma-project/control-plane/components/provisioner => github.com/rJankowski93/control-plane/components/provisioner v0.0.0-20210614050420-23d9a6a2b66f
