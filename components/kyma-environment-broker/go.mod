...
require (
	...
	github.com/kyma-incubator/compass/components/director v0.0.0-20220603074029-6e2e4b4d5ce0
	github.com/kyma-incubator/reconciler v0.0.0-20220530112659-7c7730de8709
	github.com/kyma-project/control-plane/components/provisioner v0.0.0-20220603085229-28da147ebbd5
