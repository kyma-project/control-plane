...
func TestService_ProvisionRuntime(t *testing.T) {
	...
	t.Run("Should start runtime provisioning of Gardener cluster and return operation ID", func(t *testing.T) {
		...
		downloader := &mocks2.ResourceDownloader{}
		downloader.On("Download", kymaVersion, mock.AnythingOfType("[]*gqlschema.ComponentConfigurationInput")).Return(nil)

		service := NewProvisioningService(inputConverter, graphQLConverter, directorServiceMock, sessionFactoryMock, provisioner, uuidGenerator, provisioningQueue, nil, nil, nil, nil, downloader)
	...
	t.Run("Should return error and unregister Runtime when failed to commit transaction", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, directorServiceMock, sessionFactoryMock, provisioner, uuidGenerator, nil, nil, nil, nil, nil, downloader)
	...
	t.Run("Should return error when failed to register Runtime", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, directorServiceMock, nil, nil, uuidGenerator, nil, nil, nil, nil, nil, downloader)
...
func TestService_UpgradeRuntime(t *testing.T) {
	...
	t.Run("Should start runtime provisioning of Gardener cluster and return operation ID", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactory, nil, uuidGenerator, provisioningQueue, deprovisioningQueue, upgradeQueue, upgradeShootQueue, nil, nil)
...
func TestService_UpgradeGardenerShoot(t *testing.T) {
	...
	t.Run("Should start runtime provisioning of Gardener cluster and return operation ID", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactory, provisioner, uuidGenerator, nil, nil, nil, upgradeShootQueue, nil, nil)
...
func TestService_HibernateShoot(t *testing.T) {
	...
	t.Run("Should hibernate cluster and return operation ID", func(t *testing.T) {
		...
		service := NewProvisioningService(inputConverter, graphQLConverter, nil, sessionFactoryMock, provisionerMock, uuidGenerator, nil, nil, nil, nil, hibernationQueue, nil)
