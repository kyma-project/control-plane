...
func (_m *ReadWriteSession) UpdateShootNetworkingFilterDisabled(runtimeID string, shootNetworkingFilterDisabled *bool) apperrors.AppError {
...
// NewReadWriteSession creates a new instance of ReadWriteSession. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewReadWriteSession(t interface {
	mock.TestingT
	Cleanup(func())
}) *ReadWriteSession {
	mock := &ReadWriteSession{}
	mock.Mock.Test(t)
