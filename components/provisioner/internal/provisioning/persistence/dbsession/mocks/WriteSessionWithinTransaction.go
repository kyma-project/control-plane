...
func (_m *WriteSessionWithinTransaction) UpdateShootNetworkingFilterDisabled(runtimeID string, shootNetworkingFilterDisabled *bool) apperrors.AppError {
...
type mockConstructorTestingTNewWriteSessionWithinTransaction interface {
	mock.TestingT
	Cleanup(func())
}

// NewWriteSessionWithinTransaction creates a new instance of WriteSessionWithinTransaction. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewWriteSessionWithinTransaction(t mockConstructorTestingTNewWriteSessionWithinTransaction) *WriteSessionWithinTransaction {
	mock := &WriteSessionWithinTransaction{}
	mock.Mock.Test(t)
