...
type NewWriteSessionWithinTransactionT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewWriteSessionWithinTransaction(t NewWriteSessionWithinTransactionT) *WriteSessionWithinTransaction {
