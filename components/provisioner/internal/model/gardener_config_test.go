...
func Test_PutShootNetworkingExtension(t *testing.T) {
	for _, testCase := range []struct {
		description                           string
		shoot                                 *gardener_types.Shoot
		upgradeConfig                         GardenerConfig
		expectedShootNetworkingFilterDisabled *bool
	}{
		{
			description:                           "no extension, no upgrade",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: nil}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: nil},
			expectedShootNetworkingFilterDisabled: nil,
		},
		{
			description:                           "no extension, upgrade to true",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: nil}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: util.BoolPtr(true)},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(true),
		},
		{
			description:                           "no extension, upgrade to false",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: nil}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: util.BoolPtr(false)},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(false),
		},
		{
			description:                           "true extension, no upgrade",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: []gardener_types.Extension{{Disabled: util.BoolPtr(true), Type: ShootNetworkingFilterExtensionType}}}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: nil},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(true),
		},
		{
			description:                           "true extension, upgrade to true",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: []gardener_types.Extension{{Disabled: util.BoolPtr(true), Type: ShootNetworkingFilterExtensionType}}}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: util.BoolPtr(true)},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(true),
		},
		{
			description:                           "true extension, upgrade to false",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: []gardener_types.Extension{{Disabled: util.BoolPtr(true), Type: ShootNetworkingFilterExtensionType}}}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: util.BoolPtr(false)},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(false),
		},
		{
			description:                           "false extension, no upgrade",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: []gardener_types.Extension{{Disabled: util.BoolPtr(false), Type: ShootNetworkingFilterExtensionType}}}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: nil},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(false),
		},
		{
			description:                           "false extension, upgrade to true",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: []gardener_types.Extension{{Disabled: util.BoolPtr(false), Type: ShootNetworkingFilterExtensionType}}}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: util.BoolPtr(true)},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(true),
		},
		{
			description:                           "false extension, upgrade to false",
			shoot:                                 &gardener_types.Shoot{Spec: gardener_types.ShootSpec{Extensions: []gardener_types.Extension{{Disabled: util.BoolPtr(false), Type: ShootNetworkingFilterExtensionType}}}},
			upgradeConfig:                         GardenerConfig{ShootNetworkingFilterDisabled: util.BoolPtr(false)},
			expectedShootNetworkingFilterDisabled: util.BoolPtr(false),
		},
		...
		t.Run(testCase.description, func(t *testing.T) {
			// given
			expectedUpdated := testCase.upgradeConfig.ShootNetworkingFilterDisabled != nil

			// when
			updated := PutShootNetworkingExtension(testCase.upgradeConfig, testCase.shoot)
			updatedDisabled := util.BoolPtr(false)
			updatedDisabled = nil
			for _, extension := range testCase.shoot.Spec.Extensions {
				if extension.Type == ShootNetworkingFilterExtensionType {
					updatedDisabled = extension.Disabled
				}
			}

			assert.Equal(t, expectedUpdated, updated)
			assert.Equal(t, util.UnwrapBoolOrDefault(testCase.expectedShootNetworkingFilterDisabled, false), util.UnwrapBoolOrDefault(updatedDisabled, false))
		})
	}
}
