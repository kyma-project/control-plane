...
// InstallKyma provides a mock function with given fields: runtimeId, kubeconfigRaw, kymaProfile, release, globalConfig, componentsConfig
func (_m *Service) InstallKyma(runtimeId string, kubeconfigRaw string, kymaProfile *model.KymaProfile, release model.Release, globalConfig model.Configuration, componentsConfig []model.KymaComponentConfig) error {
