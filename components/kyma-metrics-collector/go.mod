...
require (
	...
	github.com/gardener/gardener-extension-provider-aws v1.47.0
	github.com/gardener/gardener-extension-provider-azure v1.38.1
	github.com/gardener/gardener-extension-provider-gcp v1.32.0
