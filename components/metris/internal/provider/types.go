...
type Config struct {
	...
	MaxRetries      int           `kong:"help='Number of maximum retries until a cluster is removed from the cache in case of not being found on the provider. This will stop sending events for the removed cluster!',env='PROVIDER_MAXRETRIES',required=true,default=20"`
