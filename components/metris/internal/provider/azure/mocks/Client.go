...
import (
	...
	network "github.com/Azure/azure-sdk-for-go/services/network/mgmt/2020-06-01/network"
...
func (_m *Client) GetEHNamespaces(ctx context.Context, rgname string, logger log.Logger) ([]eventhub.EHNamespace, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, log.Logger) []eventhub.EHNamespace); ok {
		r0 = rf(ctx, rgname, logger)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Client) GetPublicIPAddresses(ctx context.Context, rgname string, logger log.Logger) ([]network.PublicIPAddress, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, log.Logger) []network.PublicIPAddress); ok {
		r0 = rf(ctx, rgname, logger)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Client) GetVMResourceSkus(ctx context.Context, filter string, logger log.Logger) ([]compute.ResourceSku, error) {
	ret := _m.Called(ctx, filter, logger)

	var r0 []compute.ResourceSku
	if rf, ok := ret.Get(0).(func(context.Context, string, log.Logger) []compute.ResourceSku); ok {
		r0 = rf(ctx, filter, logger)
	} else {
		if ret.Get(0) != nil {
...
// GetVirtualMachines provides a mock function with given fields: ctx, rgname, logger
func (_m *Client) GetVirtualMachines(ctx context.Context, rgname string, logger log.Logger) ([]compute.VirtualMachine, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, log.Logger) []compute.VirtualMachine); ok {
		r0 = rf(ctx, rgname, logger)
	} else {
		if ret.Get(0) != nil {
...
// GetVirtualNetworks provides a mock function with given fields: ctx, rgname, logger
func (_m *Client) GetVirtualNetworks(ctx context.Context, rgname string, logger log.Logger) ([]network.VirtualNetwork, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, log.Logger) []network.VirtualNetwork); ok {
		r0 = rf(ctx, rgname, logger)
	} else {
		if ret.Get(0) != nil {
