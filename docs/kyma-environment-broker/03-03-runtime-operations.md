...
| Provision Azure Resource Group         | Azure                    | Creates the Azure Resource Group that will be used in other Azure related steps.                                                                | @nachtmaar (Team SkyDivingTunas), @tgorgol (Team Wookiee)        |
...
| Provision Azure Container Registry     | Serverless               | Creates the Azure Container Registry that will be used by Serverless to store lambda functions' images.                                         | @tgorgol (Team Wookiee)        |
...
| Deprovision Azure Resource Group | Azure  | Done | Deletes the Azure Resource Group along with all resources it contains.                                                  | @montaro (Team SkyDivingTunas), @tgorgol (Team Wookiee)      |
