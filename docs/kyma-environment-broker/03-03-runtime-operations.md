...
| Provision Azure Resource Group         | Azure                    | Creates the Azure Resource Group that is used in other Azure-related steps.                                                                | @nachtmaar (Team SkyDivingTunas), @tgorgol (Team Wookiee)        |
...
| Provision Azure Container Registry     | Serverless               | Creates the Azure Container Registry that is used by Serverless to store images of lambda functions.                                         | @tgorgol (Team Wookiee)        |
...
| Deprovision Azure Resource Group | Azure  | Done | Deletes the Azure Resource Group along with all resources it contains, such as Azure Container Registry and/or Azure Event Hubs.                                                  | @montaro (Team SkyDivingTunas), @tgorgol (Team Wookiee)      |
