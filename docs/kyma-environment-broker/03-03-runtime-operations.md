...
| Provision Azure Resource Group         | Azure                    | Creates the Azure Resource Group that will be used in other Azure related steps.                                                                | @tgorgol (Team Wookiee)        |
...
| Deprovision Azure Resource Group | Azure  | In progress | Deletes the Azure Resource Group along with all resources it contains.                                                  | @montaro (Team SkyDivingTunas)   |
