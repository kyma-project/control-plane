...
| **APP_DATABASE_SSLMODE** | Activates the SSL mode for PostgreSQL. For reference, see the list of [all the possible values](https://www.postgresql.org/docs/9.1/libpq-ssl.html).  
